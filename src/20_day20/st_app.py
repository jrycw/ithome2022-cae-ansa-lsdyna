    ...
    if check_password():
        with st.form('submit-form'):
            ...
            with plate:
                ...
                with col_32:
                    move_x_p = st.number_input(
                        'move_x_p(mm)', value=0.0, step=1.0)
                with col_33:
                    move_y_p = st.number_input(
                        'move_y_p(mm)', value=0.0, step=1.0)
                with col_34:
            ...
            with box:
                ...
                with col_71:
                    z_elv_b = st.number_input(
                        'z_elv_b(mm)', value=5.0, step=1.0)
                with col_72:
            ...
            if submit_button:
                ...
                crtl_params_model = CRTLParamsModel(
                    **{'vz': vz, 'endtim': endtim})
